...
from database import db, get_doctor_names, get_procedure_settings
...
def index():
    ...
    return render_template(
        'index.html', table=table, title=title, doctor=doctor, doctor_names=get_doctor_names(),
        procedure_settings={d: get_procedure_settings(d) for d in get_doctor_names()}
    )
